![Cover Image](https://github.com/chintanrparmar/DailyNASA/blob/master/cover_image.png)

***You can Install the Sample app by clicking below 👇***

[![DailyNASA App](https://img.shields.io/badge/DailyNASA-APK-blue)](https://github.com/chintanrparmar/DailyNasa/raw/master/sample-app.apk)

## About

It uses the [NASA APOD API](https://api.nasa.gov/) to display the Astronomy Picture of the Day. 
...
[Dev Profile](https://twitter.com/chintanrparmar)
